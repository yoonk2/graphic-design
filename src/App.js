    ...
    <div className="App">
      <nav>
        <h2>Sorting Algorithms
          ...
          <p className="project-info">정렬 알고리즘이 시각화된 이미지를 아카이빙한 웹사이트입니다. 정렬 알고리즘은 컴퓨터공학에서 중요하게 다루어지는 주제 중 하나입니다. 본 웹사이트의 제작자 또한 정렬 알고리즘 공부를 시도했지만, 알고리즘 자체보다 알고리즘의 '움짤'에 더 관심이 가 이미지들을 수집하고 높이순으로 재배치하여 웹사이트를 제작했습니다. 알고리즘 공부에 도움이 되지는 않겠지만, 아름다운 이미지들을 구경하며 즐겨보세요. 웹사이트 제작에 영감이 된 <a href="https://youtu.be/vr5dCRHAgb0">유튜브 영상</a>을 함께 보며 둘러보셔도 좋습니다.<button>X</button></p>
        </h2>
